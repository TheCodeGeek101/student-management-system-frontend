  ...
  return (
    <li>
      <Link
        href={item.route}
        onClick={handleClick}
        className={`${isItemActive ? "bg-blue-400 text-white" : "text-gray-600"} group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-black duration-300 ease-in-out`}
      >
        {item.icon}
        {item.label}
        {item.children && (
