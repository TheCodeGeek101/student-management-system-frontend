    ...
    },
    {
      ...
      cell: (row: Transaction) => (
        <div className="flex justify-around">
          <Link href={`/Student/Payments/verify/${row.tx_ref}`}>
            <button
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await axios.post(`/api/GetStudentTransactions`, { 
          endPoint:endPoint,
          studentId: studentId
          ...
          <div className="mb-8 mt-20 flex flex-col gap-12">
            <div className="bg-white shadow rounded-lg">
              <div className="flex justify-between items-center bg-blue-400 p-6 rounded-t-lg">
                ...
                <h2 className="text-2xl font-bold text-white">Transactions Table</h2>
                <button
