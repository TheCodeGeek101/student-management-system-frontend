...
export default function PaymentIndex() {
  ...
  const cardDetails: CardDetail[] = [
    {
      title: 'Make payments',
      description: 'Click here to pay for your school fees or uniform',
      name: 'create',
      link:'/Student/Payments/fees-payments'
    },
    {
      title: 'Recent Transactions',
      description: 'Click here to view the recent transactions made',
      name: 'view',
      link: '/Student/Payments/transactions'
    },
