        ...
        <div className="flex justify-around">
          ...
          <Link href={`/Admin/departments/edit/department/${row.id}`}>
            <button
              ...
              className="mr-4 rounded bg-blue-400 px-2 py-2 text-white transition duration-300 hover:bg-primary focus:outline-none focus:ring focus:ring-yellow-300"
            >
          ...
          <div className="bg-white shadow rounded-lg">
            <div className="flex justify-between items-center bg-blue-400 p-6 rounded-t-lg">
              <div className="flex items-center">
                <h2 className="text-2xl font-bold text-white">Departments Table</h2>
              </div>
              <button
